...
<body data-spy="scroll" data-target="#pb-navbar" data-offset="200">
	...
	<section class="site-hero" style="background-image: url(images/augusto_coelho.jpg);" id="section-home" data-stellar-background-ratio="0.5">
		<div class="container">
			<div class="row intro-text align-items-center justify-content-center">
				<div class="col-md-10 text-center pt-5">

					<h1 class="site-heading site-animate">Olá, Eu sou <strong class="d-block">Augusto Coelho</strong></h1>
					<strong class="d-block text-white text-uppercase letter-spacing">e essa é a minha história profissional</strong>
		...
		<div class="container">
			<div class="row mb-5 align-items-center">
				<div class="col-lg-7 pr-lg-5 mb-5 mb-lg-0">
					<img src="images/augusto_coelho_linkedin.jpg" alt="Augusto no sede do Linkedin em Toronto Canadá" class="img-fluid">
				</div>
	...
	<section class="site-section">
		<div class="container">
			<div class="row mb-5">
				<div class="col-md-12">
					<div class="section-heading text-center">
						<h2>Linkedin <strong>Recomendações</strong></h2>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					...
					<div class="block-47 d-flex mb-5">
						...
						<blockquote class="block-47-quote">
							...
							<cite class="block-47-quote-author">&mdash; Italo Martins, Desenvolvedor de Software <a href="#">Portix Logistic Software</a></cite>
						</blockquote>
					</div>
				...
				<div class="col-md-6">
					...
					<div class="block-47 d-flex mb-5">
						...
						<blockquote class="block-47-quote">
							...
							<cite class="block-47-quote-author">&mdash; Domingos Sávio, Analista <a href="#">Unimed Fortaleza</a></cite>
						</blockquote>
					</div>
			...
			<div class="row mb-5">
				<div class="col-md-12 text-center">
					<p>
						...
						<a title="Aqui você vai visitar o meu Instagram" href="https://www.instagram.com/augusto_cesar_coelho/" class="social-item"><span class="icon-instagram2"></span></a>
						<a title="Aqui você vai visitar o meu Linkedin" href="https://www.linkedin.com/in/augustocesarcoelho/" class="social-item"><span class="icon-linkedin2"></span></a>
